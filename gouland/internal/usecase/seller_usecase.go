...
// SellerUsecase defines application-level operations for sellers
...
type sellerUsecase struct{
	repo ports.SellerRepo
}

func NewSellerUsecase(r ports.SellerRepo) SellerUsecase {
...
func (u *sellerUsecase) GetAll(ctx context.Context) ([]domain.Seller, error) { return u.repo.GetAll(ctx) }
...
func (u *sellerUsecase) Delete(ctx context.Context, id string) error {
